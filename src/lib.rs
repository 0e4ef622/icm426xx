...
mod test {
    ...
    async fn test_init0() {
        ...
        let icm = super::ICM42688::new(&mut spi);
        let _icm = icm.initialize(NoopDelay, Default::default()).await.unwrap();
        spi.done();
    }
    ...
    async fn test_init1() {
        let mut spi = spi::Mock::new(&[
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![145, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![17, 255]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![245, 0], vec![0xff, 0x47]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![148, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![20, 254]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![150, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![22, 255]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![204, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![76, 255]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![205, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![77, 127]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![207, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![79, 22]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![208, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![80, 22]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![209, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![81, 243]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![210, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![82, 0]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![211, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![83, 231]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![212, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![84, 253]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![223, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![95, 247]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![224, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![96, 0]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![225, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![97, 240]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![227, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![99, 251]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![228, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![100, 239]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![229, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![101, 255]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![118, 1]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![139, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![11, 252]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![140, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![12, 205]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![141, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![13, 170]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![142, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![14, 128]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![251, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![123, 249]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![118, 2]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![131, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![3, 154]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![132, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![4, 170]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![133, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![5, 128]),
            spi::Transaction::transaction_end(),
            ...
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::transfer_in_place(vec![206, 0], vec![0xff, 0xff]),
            spi::Transaction::transaction_end(),
            spi::Transaction::transaction_start(),
            spi::Transaction::write_vec(vec![78, 255]),
            spi::Transaction::transaction_end(),
        ]);
        let icm = super::ICM42688::new(&mut spi);
        let _icm = icm.initialize(NoopDelay, Default::default()).await.unwrap();
